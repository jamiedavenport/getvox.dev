...
Ready to get started? Check out our [Getting Started guide](/getting-started) to set up Vox in your project.

- **[Getting Started](/getting-started)** - Complete setup guide
- **[Frontend Integration](/frontend)** - Framework-specific guides
- **[Backend Integration](/backend)** - Server-side implementation
...
*Ready to transform how you collect user feedback? [Get started now](/getting-started) and see the difference Vox can make in your product development process.*